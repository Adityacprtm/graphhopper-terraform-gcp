...
if (ghenv.mapilion.api_key) mapilionAddition = "?key=" + ghenv.mapilion.api_key;

var osAPIKey = "mapsgraph-bf48cc0b";
if (ghenv.omniscale.api_key) osAPIKey = ghenv.omniscale.api_key;
...
var omniscale = L.tileLayer(
    ...
    (retinaTiles ? "?hq=true" : ""),
  {
    layers: "osm",
    attribution:
      osmAttr + ', &copy; <a href="https://maps.omniscale.com/">Omniscale</a>',
  }
);
...
var sorbianLang = L.tileLayer(
  "http://a.tile.openstreetmap.de/tiles/osmhrb/{z}/{x}/{y}.png",
  {
    attribution:
      osmAttr +
...
var thunderTransport = L.tileLayer(
  "https://{s}.tile.thunderforest.com/transport/{z}/{x}/{y}.png" + tfAddition,
  {
    attribution:
      osmAttr +
...
var thunderCycle = L.tileLayer(
  "https://{s}.tile.thunderforest.com/cycle/{z}/{x}/{y}.png" + tfAddition,
  {
    attribution:
      osmAttr +
...
var thunderOutdoors = L.tileLayer(
  "https://{s}.tile.thunderforest.com/outdoors/{z}/{x}/{y}.png" + tfAddition,
  {
    attribution:
      osmAttr +
...
var thunderNeighbourhood = L.tileLayer(
...
var kurvigerLiberty = L.tileLayer(
  "https://{s}-tiles.mapilion.com/raster/styles/kurviger-liberty/{z}/{x}/{y}{r}.png" +
    mapilionAddition,
  {
...
module.exports.enableVectorTiles = function () {
  var omniscaleGray = L.tileLayer(
    "https://maps.omniscale.net/v2/" +
      osAPIKey +
      "/style.grayscale/layers.world,buildings,landusages,labels/{z}/{x}/{y}.png?" +
      (retinaTiles ? "&hq=true" : ""),
    {
      layers: "osm",
      attribution:
        osmAttr +
        ', &copy; <a href="https://maps.omniscale.com/">Omniscale</a>',
    }
  );
  ...
  var vtLayer = L.vectorGrid
    .protobuf(
      "/mvt/{z}/{x}/{y}.mvt?details=max_speed&details=road_class&details=road_environment",
      {
...
module.exports.selectLayer = function (layerName) {
  ...
  if (!defaultLayer) defaultLayer = module.exports.defaultLayer;
